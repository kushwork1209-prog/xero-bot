...
from .embeds import (
    ...
    giveaway_embed, raid_alert_embed, escalation_embed,
    stock_embed, milestone_embed, health_embed, XERO, XeroColors,
...
__all__ = [
    ...
    "raid_alert_embed","escalation_embed","stock_embed",
    "milestone_embed","health_embed","XERO","XeroColors",
